...
def no_install_setup_requires():
    ...
    Under PEP 517, the config reports build dependencies to the frontend,
    and the frontend is responsible for ensuring they're installed.
    So setuptools (acting as a config) should not try to install them.
    """
...
class _BuildMetaLegacyBackend(_BuildMetaBackend):
    """Compatibility config for setuptools
